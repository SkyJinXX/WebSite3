        ...
        <div class="main">
            ...
            <div class="right">
                ...
                <div class="messagebox">
                    <h1>留言　Message<br>
                        <span>请以填写正确的信息，留言给我们，我们会在第一时间给你回复。</span></h1>
                    <form  runat="server" method="post" onsubmit="return check()">
                        <ul>
                            <li>姓名：<input runat="server" name="name" id="name" type="text" style="width: 95px;">
                                <font>*</font></li>
                            <li>邮箱：<input runat="server" name="email" id="email" type="text" style="width: 190px;">
                                <font>*</font></li>
                            <li>电话：<input runat="server" name="tel" id="tel" type="text" style="width: 135px;">
                                <font>*</font></li>
                            <li>留言：<textarea runat="server" name="content" id="content" style="width: 300px; height: 95px;"></textarea>
                                <font>*</font></li>
                            <li>
                                <asp:Button ID="Button_submit_message" runat="server" Text="提交" Style="height: 25px; width: 80px; line-height: 25px;" OnClick="Button_submit_message_Click" />
                            </li>
                        </ul>
                    </form>
                    <script>
