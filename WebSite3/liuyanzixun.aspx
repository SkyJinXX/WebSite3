<%@ Page Language="C#" AutoEventWireup="true" CodeFile="liuyanzixun.aspx.cs" Inherits="liuyanzixun" %>
    ...
    <div class="main">
    	...
    	<div class="right">
            <div class="position">
                ...
                <a href="http://www.gdfdp.org/index.html">首页</a> &gt; 留言咨询
            </div>
            
           
           <div class="messagebox">
           		<h1>留言　Message<br><span>请以填写正确的信息，留言给我们，我们会在第一时间给你回复。</span></h1>
                <form method="post" action="http://www.gdfdp.org/contact_us/message" onsubmit="return check()">
           		<ul>
                	<li>　姓名：<input name="name" id="name" type="text" style="width:95px;"> <font>*</font></li>
                    <li>　邮箱：<input name="email" id="email" type="text" style=" width:190px;"> <font>*</font></li>
                    <li>　电话：<input name="tel" id="tel" type="text" style="width:135px;"> <font>*</font></li>
                    <li>　留言：<textarea name="content" id="content" style="width:300px; height:95px;"></textarea> <font>*</font></li>
                                        <li>　　　　<input type="submit" value="提交" style=" height:25px; width:80px; line-height:25px;"></li>
                </ul>
                </form>
<script>
function check(){
