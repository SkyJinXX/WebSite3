<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lianxiwomen.aspx.cs" Inherits="lianxiwomen" %>
    ...
    <div class="main">
    	...
    	<div class="right">
        	<div class="position">
                ...
                <a href="http://www.gdfdp.org/index.html">首页</a> &gt; 联系我们
            ...
            <div class="contact_us">
            	<div class="l">
                	<h1>联系方式　Contact</h1>
                    <dl>
                        <dt>“天使之音”残疾人关爱服务中心</dt>
                        <dd>电话：</dd>
                        <dd>公司传真：020-83371369</dd>
                        <dd>地址：</dd>
                        <dd>E-MAIL：</dd>
                        <dd>网址：</dd>
                    </dl>
            	...
            	<div class="r">
                	<img src="./联系我们_files/map2.jpg" width="354" height="248">
                </div>
                <div class="c"></div>
            </div>
